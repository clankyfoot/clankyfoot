...
namespace Clankyfoot.Controllers
{
    public class TeamController : Controller
    {
        ...
        /// <summary>
        /// Loads a Change Email View for the user
        /// </summary>
        /// <returns></returns>
        ...
        [ValidateAntiForgeryToken]
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult ChangeEmail(Clankyfoot.Models.TeamMemberChangeEmail model)
        {
            if(ModelState.IsValid)
            {
                // TODO create update team member e-mail logic
                return View();
            }
            else
            {
                ModelState.AddModelError("", "Please make sure the e-mail is correct, and re-enter your password");
                return View();
            }
        }
